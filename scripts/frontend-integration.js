 ...
 * This file demonstrates how to integrate Vallex with a web frontend
 */

// For React/Vue/Angular applications
export class VallexClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new VallexClient(provider, contractAddress);
